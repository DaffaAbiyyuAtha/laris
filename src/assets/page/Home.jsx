...
function Home() {
  ...
  const handleCategoryClick = (category) => {
    navigate("/categories", { state: { activeComponent: category } });
  };
    ...
    <>
      ...
      <div className="flex flex-col gap-10">
        ...
        <div className="flex justify-center">
          ...
          {activeComponent && handleCategoryClick(activeComponent)}
          {activeComponent === "TV" && handleCategoryClick}
          {activeComponent === "Speaker" && handleCategoryClick}
          {activeComponent === "Headset" && handleCategoryClick("Headset")}
          {activeComponent === "HP" && handleCategoryClick}
        ...
        <div className="flex flex-col gap-10 px-28">
          ...
          <div className="flex bg-[#33BEC5] py-6 pr-6 rounded">
            <div className="flex w-2/3 gap-2">
              ...
              >
                <div className="bg-[#ECF6FF] rounded p-5 flex-shrink-0">
                  ...
                  <div className="text-center font-semibold">Rp 2.450.000</div>
                </div>
                <div className="bg-[#ECF6FF] rounded p-5 flex-shrink-0">
                  <div className="mb-4">
                    <img
              ...
              <div className="flex gap-2 h-full items-end">
                <div
                  className="bg-[#ECF6FF] p-1 rounded cursor-pointer"
            ...
            <div className="flex font-semibold justify-center gap-5 text-white flex-col items-center w-1/3">
              <div className="flex gap-4 items-end">
                <div className="text-3xl">Discount</div>
                <div className="text-5xl">10%</div>
              </div>
              <div className="text-3xl">For January</div>
            </div>
          </div>
          ...
          <div className="">
            <div className="flex justify-between font-semibold text-2xl mb-3">
              <div className="text-[#408A89]">New Product</div>
              <div className="flex gap-1 items-end text-white">
                <div
                  className="bg-[#408A89] text-xs p-1 rounded cursor-pointer"
                ...
                return (
                  ...
                  >
                    <div className="flex flex-col justify-center items-center gap-3 bg-[#ECF6FF] font-semibold p-2 rounded shadow-lg flex-shrink-0">
                      ...
                      <div className="text-xl">{items.nameProduct}</div>
                      <div className="">
            ...
            <div className="flex gap-5 bg-[#ECF6FF] p-12 rounded">
              <div className="w-1/3 flex flex-col gap-5">
                <div className="flex items-center justify-center flex-col gap-2 bg-white p-2 rounded flex-grow">
                  ...
                  <div className="text-2xl font-semibold">Galaxy Watch 6</div>
                  <div className="text-2xl font-semibold">Rp 2.450.000</div>
                </div>
              </div>
