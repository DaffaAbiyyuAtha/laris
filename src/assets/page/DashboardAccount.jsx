...
function DashboardAccount() {
  ...
  async function updateProfile(profile) {
    ...
    const dataProfile = await fetch("http://localhost:8100/profile/picture", {
      method: "PATCH",
      headers: {
    ...
    <div className="flex h-screen text-[#0C0D36]">
      ...
      <div className="bg-[rgb(245,245,251)] w-4/5 p-10 flex flex-col h-screen">
        <div className="flex justify-between">
          <div className="text-2xl text-[#0C0D36]">My Account</div>
          <div className="">
            <NavbarDashboard />
          </div>
        </div>
        <div className="text-[#9191A9] mb-6">Update your current profile</div>
        {message && (
          <div
        ...
        <form
          ...
          className="bg-white p-10 rounded-lg text-[#0C0D36] h-screen relative"
        >
