...
export default function CategorySpeaker() {
  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        const res = await fetch("http://localhost:8100/categories/filter?search=Speaker");
              ...
              {displayedProducts.map((product, index) => (
                ...
                >
                  <div className="flex flex-col gap-4">
                    <img src={product.image[0]} alt={product.nameProduct} />
